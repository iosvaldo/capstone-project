...
puts "👥 Seeding Users..."
user1=User.create(name:"Adam",username:"Adam555",password:"password123",password_confirmation:"password123",has_agreed:"true")
user1=User.create(name:"Beddy",username:"Beddy555",password:"password123",password_confirmation:"password123",has_agreed:"true")
