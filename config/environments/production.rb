...
Rails.application.configure do
  ...
  #config.action_cable.url = 'wss://in-my-f33lings.herokuapp.com/cable'
  #config.action_cable.allowed_request_origins = [ 'http://in-my-f33lings.herokuapp.com', /http:\/\/in-my-f33lings.herokuapp.com.*/ ]
